...
from cns.channel import FileChannel, FileMultiChannel, MultiChannel
...
class PhysiologyController(Controller):
    ...
    buffer_raw              = Instance(FileMultiChannel)
    buffer_proc             = Instance(FileMultiChannel)
    buffer_ts               = Instance(FileMultiChannel)
    buffer_ttl              = Any

...
from enthought.traits.api import Bool, Enum, Tuple, Instance, Int, Float
from enthought.enable.base_tool import BaseTool

class BarChartEditTool(BaseTool):
    ...
    # programmatically) and erroneously initiating a drag.
    ...
    def dragging(self, event):
        ...
        data_x, data_y = self.snap(data_x, data_y)

...
the code more readable.  Now that you've configured the circuit and are ready to
record:
...
Alternatively, you can simply use a convenience method, :func:`DSPCircuit.acquire`:

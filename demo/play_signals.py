...
def demo_mouse_mode(backend='TDT'):
    ...
    #circuit.set_tag('reset', 1)
    # Switch when TTL1 fires
    #circuit.set_tag('switch', 1)

    #TTL1a = circuit.get_buffer('TTL1a')
    DACA1 = circuit.get_buffer('DAC-A1')
    DACA2 = circuit.get_buffer('DAC-A2')
    #TTL1b = circuit.get_buffer('TTL1b')
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        ...
        print 'usage: play_signals.py <function> <backend>'
        sys.exit()
